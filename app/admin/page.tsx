  ...
  return (
    <main className="min-h-screen pb-24 bg-[var(--color-bg-primary)]">
      ...
      <div className="glass sticky top-0 z-50 h-11 flex items-center px-4">
        <button type="button" onClick={() => { try { router.push("/"); } catch { window.location.href = "/"; } }} className="flex items-center gap-1.5 text-sm text-[var(--color-text-secondary)] hover:text-[var(--color-accent)] transition-all duration-200 cursor-pointer z-10 relative">
