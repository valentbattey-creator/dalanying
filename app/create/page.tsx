...
const ALL_CATEGORIES = [
  ...
  "清谈", "白月光", "浮生情事", "红尘缘", "修行", "健康", "手工", "家居", "天文", "趣闻", "科普",
];
...
const KEYWORD_MAP: Record<string, string> = {
  ...
  "彩礼": "红尘缘", "结婚": "红尘缘", "相亲": "红尘缘", "婚礼": "红尘缘", "离婚": "红尘缘",
  "爱情": "浮生情事", "恋爱": "浮生情事", "异地恋": "浮生情事", "分手": "浮生情事", "出轨": "浮生情事",
  "修行": "修行", "自律": "修行", "独立": "修行",
    ...
    <>
      <main className="min-h-screen pb-20 bg-[var(--color-bg-primary)]">
        ...
        <div className="glass sticky top-0 z-50 h-11 flex items-center px-4">
          <button type="button" onClick={() => { try { router.push("/"); } catch { window.location.href = "/"; } }} className="flex items-center gap-1.5 text-sm text-[var(--color-text-secondary)] hover:text-[var(--color-accent)] cursor-pointer z-20 relative transition-all duration-200">
