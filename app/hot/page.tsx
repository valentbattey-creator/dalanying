    ...
    <main className="min-h-screen bg-[var(--color-bg-primary)]" style={{ paddingTop: "16px", paddingBottom: "80px" }}>
      <div className="max-w-lg mx-auto px-4">
        ...
        <div className="flex items-center gap-3 mb-4">
          <button onClick={() => router.back()} style={{ width: 36, height: 36, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: 10, backgroundColor: "var(--color-bg-card)", border: "0.5px solid var(--color-border-subtle)", cursor: "pointer", color: "var(--color-text-secondary)" }}>
