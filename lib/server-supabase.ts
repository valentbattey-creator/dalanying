...
// Service role key (bypasses RLS) - always use this for server-side operations
const SERVICE_ROLE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFhd29hamhtaHZ5c2VkYWJuY296Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4MzYwMDI4OCwiZXhwIjoyMDk5MTc2Mjg4fQ.jGRT49Be9LTmSI17dDwy9WIJy8FRzQWBcBG1NJC1fcA";
